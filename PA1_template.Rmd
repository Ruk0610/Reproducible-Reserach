...
xyplot(MeanStep ~ interval | WeekSplit, data = steps_by_interval2, layout = c(1,2), type = "l", main = "Weekend vs Weekday Average Number of Steps", xlab = "5 min interval", ylab = "Avg Steps taken")
